...
describe("parse", function()
  ...
  describe("statements", function()
    it("should parse sequences of statements", function()
      ...
      assert.are.same(result[1].block.body,
        { tag = "seq", st1 = { tag = "number", val = 10 }, st2 = { tag = "number", val = 20 } })
    end)
  ...
  describe("expressions", function()
    ...
    it("should parse comparison expressions", function()
      local result = parser.parse([[ function foo { return 10 > 2 } ]])
      assert.are.same(result[1].block.body.exp,
        { tag = "binop", op = ">", e1 = { tag = "number", val = 10 }, e2 = { tag = "number", val = 2 } })
    ...
    it("should parse unary expressions", function()
      ...
      assert.are.same(result[1].block.body.exp,
        { tag = "unary", sign = "-", exp = { tag = "number", val = 1 } })
    ...
    it("comparison should take precedence over logical expressions", function()
      ...
      assert.are.same(result1[1].block.body.exp,
        {
          tag = "logicalop",
          op = "or",
      ...
      assert.are.same(result2[1].block.body.exp,
        {
          tag = "logicalop",
          op = "or",
